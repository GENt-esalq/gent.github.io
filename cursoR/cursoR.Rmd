---
date: "`r Sys.Date()`"
author: "[GENt](https://gent-esalq.github.io/) <br/>  Luiz de Queiroz College of Agriculture <br/> University of São Paulo"
output:
...
* Mantenha no seu script .R somente os comandos que funcionaram e, de preferência, adicione comentários. Você pode, por exemplo, comentar nele dificuldades encontradas, para que você não cometa os mesmos erros mais tarde.


<span style="color:red"> Paramos aqui no primeiro dia. Caso não tenha salvado os objetos criados até agora, obtenha-os [aqui](https://GENt-esalq.github.io/cursoR/dia1.RData).</span>
...
* Acesse [aqui](https://GENt-esalq.github.io/cursoR/dia1.R) um exemplo de script de tudo que foi realizado até agora.
...
A planilha com os dados será disponibilizada, adicione-a ao seu diretório de trabalho ou indique o caminho da pasta ao importá-la para dentro do R, como a seguir. Caso esteja difícil encontrá-la, acesse [aqui](https://GENt-esalq.github.io/cursoR/dados_alunos.RData)
...
<span style="color:red"> Caso não tenha salvado os objetos criados até agora, obtenha-os [aqui](https://GENt-esalq.github.io/cursoR/dia2.RData). Também acesse um R script do que foi passado [aqui](https://GENt-esalq.github.io/cursoR/dia2.R)</span>
...
* Às vezes quando instalamos um pacote que já havia sido instalado, o R não reconhece o novo pacote e é necessario reiniciar o R.
...
```{r}
wordcloud(dataCorpus,max.words=100,colors=c("blue","green"))
```
...
Acesse [aqui](https://GENt-esalq.github.io/cursoR/Exercicios.html#sessao-7-algumas-ferramentas-basicas-de-analise-de-dados)
...
Também recomendamos diversos materiais em inglês [aqui](https://GENt-esalq.github.io/cursoR/english_tutorials.html).

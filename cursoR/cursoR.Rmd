...
<span style="color:red"> * Algumas Dicas: </span>
...
> Você já pode fazer em casa os exercícios da [**Sessão 1**](exercicios.html#sessao1)
...
* Acesse [aqui](../wait.html) um exemplo de script de tudo que foi realizado até agora.
...
> Agora você já pode fazer em casa os exercícios da [**Sessão 2**](exercicios.html)
...
> Faça os exercícios das [**sessão 7**](exercicios.html)

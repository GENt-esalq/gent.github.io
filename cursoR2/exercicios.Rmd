...
2 - Repita a frase "x tigre(s) triste(s) comeram x pratos de trigo", em que x seja um número inteiro da sua escolha.
...
3 - **Hora de descontrair!** Você conhece a música [Hey Jude](https://www.youtube.com/watch?v=7qMls5yxP1w)? Repita quantas vezes você quiser o verso:
